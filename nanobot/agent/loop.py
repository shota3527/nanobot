...
class AgentLoop:
    ...
    def __init__(
        ...
        self.context = ContextBuilder(workspace, timezone=timezone, tool_result_max_bytes=tool_result_max_bytes)
    ...
    async def _run_agent_loop(
        ...
        *on_stream_end(resuming)*: called when a streaming session finishes.
        ...
        class _LoopHook(AgentHook):
            ...
            def prepare_response(self, context: AgentHookContext, response):
                return loop_self._clipboard_expander.expand_response(response)
            ...
            def finalize_tool_result(self, context: AgentHookContext, tool_call, result: Any) -> Any:
                return loop_self.context._truncate_tool_result(result)
